window.addEventListener("DOMContentLoaded", () => {
    ...
    new MenuCard(
        ...
        "post",
        'Меню “Постное”',
        'Меню “Постное” - это полное отсутствие продуктов животного происхождения, молоко из миндаля, овса, кокоса или гречки, правильное количество белков за счет тофу и импортных вегетарианских стейков.',
        10,
        '.menu__field .container'
    ).render();
